...
class checkReview:
    ...
    def __init__(self, watsonx_api_key_str, project_id_str):
        
        my_credentials = {
            "url"    : "https://us-south.ml.cloud.ibm.com",
            "apikey" : watsonx_api_key_str
        }   
        project_id  = project_id_str
        
        # Defining the Model with default 'gen_parms'
        self.model = Model( model_id, my_credentials, gen_parms, project_id, space_id, verify)   
        
        # Defining the Model with corresponding 'gen_parms_sentiment_keywords'
        self.model_sentiment_keywords = Model( model_id, my_credentials, gen_parms_sentiment_keywords, project_id, space_id, verify)   
        
        # Defining the Model with corresponding 'gen_parms_summary'
        self.model_s = Model( model_id, my_credentials, gen_parms_summary, project_id, space_id, verify) 
    ...
    def checkWatsonService(self):
        ...
        model_details = self.model.get_details()
    ...
    def getEntities(self, input_review):
        ...
        generated_response_entity = self.model.generate(input_entity_prompt, gen_parms_override)
    ...
    def getSentiment(self, input_review):
        ...
        #generated_response_sentiment = self.model.generate(input_sentiment_prompt, gen_parms_override)
        generated_response_sentiment = self.model_sentiment_keywords.generate(input_sentiment_prompt, gen_parms_override)
    ...
    def getSentimentContributingTexts(self, input_review, sentiment):
        ...
        if ("positive" in sentiment) or ("negative" in sentiment): 
            ...
            # Calling model
            generated_response_response_sentiment_ContibTexts = self.model_sentiment_keywords.generate( input_sentiment_keywords_prompt, gen_parms_override )  # dict
            ...
            generated_response_response_sentiment_ContibTexts_POSITIVE = self.model_sentiment_keywords.generate( input_sentiment_keywords_prompt_POSITIVE, gen_parms_override )  # dict
            ...
            generated_response_response_sentiment_ContibTexts_NEGATIVE = self.model_sentiment_keywords.generate( input_sentiment_keywords_prompt_NEGATIVE, gen_parms_override )  # dict
    ...
    def getSummary(self, input_review):
        ...
        generated_response_summary = self.model_s.generate(input_summary_prompt, gen_parms_override)
